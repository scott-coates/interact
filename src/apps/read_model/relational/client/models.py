...
class DeliveredEa(ReadModel):
  ...
  prospect_score = models.DecimalField(max_digits=19, decimal_places=7)
  profile_score = models.DecimalField(max_digits=19, decimal_places=7)
  assigned_entity_score = models.DecimalField(max_digits=19, decimal_places=7)
  prospect_normalized_score = models.DecimalField(max_digits=19, decimal_places=7)
  profile_normalized_score = models.DecimalField(max_digits=19, decimal_places=7)
  assigned_entity_normalized_score = models.DecimalField(max_digits=19, decimal_places=7)
  score_attrs = JSONField()

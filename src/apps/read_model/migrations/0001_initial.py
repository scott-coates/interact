# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-08-18 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prospect_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('profile_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('assigned_entity_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('prospect_normalized_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('profile_normalized_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('assigned_entity_normalized_score', models.DecimalField(decimal_places=7, max_digits=19)),
                ('score_attrs', jsonfield.fields.JSONField()),
